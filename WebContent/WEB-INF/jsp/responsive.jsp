          ...
          <div class="card mb-3">
            <div class="card-header">
              <i class="fas fa-table"></i>
				<span class="marginLeft10">Product ID:</span>
				...
				<span class="marginLeft10">Description:</span>
				...
				<span class="marginLeft10">Department:</span>
				...
				<span class="marginLeft10">Shelf Life:</span>
